 ...
 */
public class FTSPolicy extends MeCardPolicy
{
    ...
    public FTSPolicy(boolean debug)
    {
        this.debug = debug;
    ...
    public boolean isResident(Customer customer, String meta)
    {
        ...
        {
            System.out.println(FTSPolicy.class.getName() + " isResident test failed: " + ex.getMessage());
        }
    ...
    public boolean isReciprocal(Customer customer, String meta)
    {
        ...
        {
            System.out.println(FTSPolicy.class.getName() + " isReciprocal test failed: " + ex.getMessage());
        }
    ...
    public boolean isInGoodStanding(Customer customer, String meta)
    {
        ...
        {
            System.out.println(FTSPolicy.class.getName() + " isInGoodStanding test failed: " + ex.getMessage());
        }
    ...
    public boolean isMinimumAge(Customer customer, String meta)
    {
        ...
        {
            System.out.println(FTSPolicy.class.getName() + " isMinimumAge test failed: " + ex.getMessage());
        }
