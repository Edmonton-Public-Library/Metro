...
public abstract class CustomerLoadNormalizer 
{
    ...
    protected void testSiteRestrictedPassword(
    ...
    )
    {
        ...
        // TODO: Is there a better place for this where we can signal the response??
        //{
        //   "name": "pin",
        //   "type": "string",
        //   "required": false,
        ...
        SitePasswordRestrictions passwordRestrictions = new SitePasswordRestrictions();
        if (passwordRestrictions.requiresHashedPassword(password))
        {
            int maxLength = passwordRestrictions.getMaxLength();
            int minLength = passwordRestrictions.getMinLength();
            password = passwordRestrictions.getHashedPassword(password, maxLength);
            System.out.println(new Date()
                + " Customer's password does not conform to the library's password requirements as follows."
                + " Max length: " + maxLength 
                + " Min length: " + minLength
                + " Allowed chars: '" + passwordRestrictions.getAllowedCharacters() + "' "
                + " A new one will be generated by"
                + " CustomerLoadNormalizer.testSiteRestrictedPassword() and set to:"
