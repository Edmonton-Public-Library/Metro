 ...
 */
public class PapiXmlStatusMessage extends PapiXmlMessage
{
    // Release numbers.
    private int major      = 0;
    private int minor      = 0;
    ...
    public PapiXmlStatusMessage(String xml) 
    {
        super(xml);
        //    "Version": "7.0.9502.0",
        //    "Major": 7,
     ...
     * 
     * @return Integer value of the minimum compliance version of the web service,
     * or in other words, the major release number.
     */
    public int getMinimumComplianceVersion()
    {
        return this.major;
    }
