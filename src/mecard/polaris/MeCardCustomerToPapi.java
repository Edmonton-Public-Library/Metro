...
//                postalCode);
        ...
        // This is described in the PAPI documentation so all sites handle gender like this.
        if (customer.isEmpty(CustomerFieldTypes.SEX) == false)
        {
            ...
            {
                customerTable.setValue(PapiElementOrder.GENDER.name(), sex);
            }
            else
            {
                customerTable.setValue(PapiElementOrder.GENDER.name(), "N");
            }
        }
