...
/**
 * Provides utility methods for computing the 'Authentication' header for
 * both protected public and staff methods.
 * 
 * @author Andrew Nisbet andrew@dev-ils.com
 * @Deprecated See PAPICommand for implementation.
 */
...
//    public static final String AUTHORIZATION_PREFIX = "PWS";
    ...
    private PapiSecurity()
    {
        ...
        this.API_USER_ID = props.getProperty(PapiPropertyTypes.API_USER_ID.toString());
        this.API_KEY     = props.getProperty(PapiPropertyTypes.API_KEY.toString());
    }
    ...
    /**
     * Computes the signature using the API access key and based on data provided.
     * @param accessKey
     * @param data
    ...
    public String getXPAPIAccessTokenHeader(String HTTPMethod, URI uri)
    {
        ...
        String signature = this.getPAPIHash(this.API_KEY, // From the properties file.
                HTTPMethod, 
                uri.toASCIIString(), 
                this.getPolarisDate(), 
                ""
        );
        return "PWS " + this.API_USER_ID + ":" + signature;
    }
    ...
    public String getSignature(String HTTPMethod, URI uri)
    {
        ...
        // •[Signature] - The signature is the following, encoded with SHA1 UTF-8:
        // [HTTPMethod][URI][Date][PatronPassword]
        String signature = this.getPAPIHash(this.API_KEY,
                HTTPMethod, 
                uri.toASCIIString(), 
                this.getPolarisDate(), 
                ""
