...
public class PAPIRequestBuilder extends ILSRequestBuilder
{
    ...
    PAPIRequestBuilder(boolean debug)
    {
        ...
        this.loginBranchId     = papiProps.getProperty(PapiPropertyTypes.LOGIN_BRANCH_ID.toString());
        this.loginUserId       = papiProps.getProperty(PapiPropertyTypes.LOGIN_USER_ID.toString());
        this.loginStationId    = papiProps.getProperty(PapiPropertyTypes.LOGIN_WORKSTATION_ID.toString());
