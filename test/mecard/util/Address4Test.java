...
public class Address4Test
{
    ...
    /**
     * Test of getStreet method, of class Address4.
     */
    @Test
    public void testAddress()
    {
        ...
        Address4 instance = new Address4(thisAddress);
        String STREET = "10255 Princess Elizabeth Avenue";
        String CITY = "Sherwood Park";
        String POSTALC = "T5G0Y1";
        String PROVINC = "AB";
        String PHONE = "X";
        ...
        System.out.println("ADDR_COMPLETE:"+thisAddress);
        instance = new Address4(thisAddress);
