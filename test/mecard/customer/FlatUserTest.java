...
public class FlatUserTest
{
    ...
    public void testToList()
    {
        ...
        flatUser.add(FlatUserExtendedFieldTypes.USER_ADDR1, FlatUserFieldTypes.CITY_STATE, "Edmonton, AB");
    ...
    public void testSetAddExtended()
    {
        ...
        FlatUser flatUser = new FlatUser();
        flatUser.setDefaultProperties();
        flatUser.add(FlatUserExtendedFieldTypes.USER_ADDR1, FlatUserFieldTypes.STREET, "11811 74 Ave.");
        assertTrue(flatUser.getField(FlatUserFieldTypes.STREET).equals("11811 74 Ave."));
        flatUser.add(FlatUserExtendedFieldTypes.USER_ADDR2, FlatUserFieldTypes.STREET, "10111 Jasper ave.");
        assertTrue(flatUser.getField(FlatUserFieldTypes.STREET).equals("11811 74 Ave."));
        flatUser.add(FlatUserExtendedFieldTypes.USER_XINFO, FlatUserFieldTypes.NOTE, "Don't lend books to this guy!");
