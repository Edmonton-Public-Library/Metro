...
## Version 4.01.01_c Through 4.01.01_f
* Minor bug fixes including SD api get status command and fixes to CITYPROV vs. CITY/STATE cross functionality for Symphony Web Service API.
...
CLASS_PATH="$MECARD_HOME/dist/lib/commons-daemon-1.4.0.jar":"$MECARD_HOME/dist/MeCard.jar"
